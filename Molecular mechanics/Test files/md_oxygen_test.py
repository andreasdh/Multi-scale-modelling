...
def calcualate_kinetic_energies(r, v, N_molecules, T, i):    
    ...
    K_theoretic = 0.5*k*T
    K_T_theoretic = (1/2)*K_theoretic
    K_R_theoretic = (1/3)*K_theoretic
    K_V_theoretic = (1/6)*K_theoretic
    output = f"""
    Step {i}
    --------------------------------------------
...
def velocity_verlet(N,m,n,r,v,R0,N_molecules,dt):
    ...
    for i in range(n):
        ...
        position_evolution.append(r)
        #calcualate_kinetic_energies(r, v, N_molecules, T, i)
...
def thermostat_Berendsen(v, E_k, dt, tau):
...
if __name__ == "__main__":
    ...
    N_molecules = 200                          # Number of molecules
